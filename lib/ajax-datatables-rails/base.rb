...
module AjaxDatatablesRails
  class Base
    ...
    class << self
      def rails_52?
        false#Rails.gem_version >= Gem::Version.new('5.2') && Rails.gem_version <= Gem::Version.new('6.0')
      end

      def rails_60?
        true#Rails.gem_version >= Gem::Version.new('6.0') && Rails.gem_version <= Gem::Version.new('6.1')
      end
